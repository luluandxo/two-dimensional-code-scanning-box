...
CAMERA_SCENE public_get_infraredType(IRCUT_SWITCH_MODE ircut_sw_m)
{
...
int public_auto_scene_control(void)
{
	...
	scene_t = public_get_infraredType(ircut_switch_mode);
...
CAMERA_SCENE public_get_scene(void)
{
	return public_camera_scene;
}

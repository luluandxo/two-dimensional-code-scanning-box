...
VB_POOL g_Pool;
char *FpnFileName= "c2390_1920x1080_10bit.raw";
HI_S32 FPN_init(const IPC_VEDIO_S* pstIpcVedio)
{
	...
	stFPNattr.stVideoFrame.stVFrame.enPixelFormat = PIXEL_FORMAT_RGB_BAYER_12BPP;
...
HI_S32 s32ReadFpnData(ISP_FPN_FRAME_INFO_S *pVBuf, FPN_ATTR_S *pstFPNattr)
{
	...
	else if (PIXEL_FORMAT_RGB_BAYER_12BPP == pstVFrameInfo->stVFrame.enPixelFormat)
	{
